...
?>
 <!-- AREA DE MODEL LOGIN -->
  <div class="modal fade" id="editGerente" tabindex="-1" role="dialog" aria-labelledby="editGerenteLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editGerenteLabel">Editar</h5>
...
<script type="text/javascript">
    $('#editGerente').on('show.bs.modal', function (event) {
