<?php
  ...
  if(!empty($nome) && !empty($endereco) && !empty($telefone) && !empty($email) && !empty($rg) && !empty($cpf) && !empty($login) && !empty($senha)
  ){
          ...
          <div class="col-lg-6 offset-lg-6">
            <div class="contact-form-section">
              ...
              <form class="contact-form-area contact-page-form contact-form text-right" method="post">
                ...
                <div class="form-group col-md-12">
                  <input type="text" class="form-control" id="rg" name="rg" placeholder="Rg" onfocus="this.placeholder = ''"
                   onblur="this.placeholder = 'Rg'">
                </div>
                <div class="form-group col-md-12">
